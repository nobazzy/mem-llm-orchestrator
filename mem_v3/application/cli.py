...
def main(argv: list[str] | None = None) -> None:
    ...
    llm_active = bool(api_key or args.llm)
    ...
    if llm_active:
        print("[1/2] Consultando LLMPlanner para diretivas de ajuste fino...")
    else:
        print("[1/2] Inicializando LocalPolicyEngine (Heurística Local)...")
