...
# MEM v89 standard run: 50M + SlimPajama/TinyStories mix.
...
export MEM_DATASET_MIX="${MEM_DATASET_MIX:-DKYoon/SlimPajama-6B:0.20,roneneldan/TinyStories:0.80}"
...
export MEM_V89_BASE_LR_REAL="${MEM_V89_BASE_LR_REAL:-2.0e-5}"
export MEM_V89_LR_PEAK_CAP="${MEM_V89_LR_PEAK_CAP:-2.0e-5}"
...
export MEM_RUN_ID="${MEM_RUN_ID:-quality_fast_50m_$(date +%Y%m%d_%H%M%S)}"
export MEM_CHECKPOINT_LABEL="${MEM_CHECKPOINT_LABEL:-v89_quality_fast}"
export CHECKPOINT_LABEL="${CHECKPOINT_LABEL:-v89_quality_fast}"
